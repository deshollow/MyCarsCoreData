...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var segmentedControl: UISegmentedControl! {
        didSet { //срабатывает когда segmentedControl инициализирован
    ...
    private func getDataFromFile() {
        //проверяю была ли загружена когда-либо дата, способ без userDefaults
        let fetchRequest: NSFetchRequest<Car> = Car.fetchRequest()
        fetchRequest.predicate = NSPredicate(format: "mark != nil") //предикат
        ...
        //получаю данные из плист файла в виде массива
        guard let pathToFile = Bundle.main.path(forResource: "data", ofType: "plist"),
              let dataArray = NSArray(contentsOfFile: pathToFile) else { return }
        //получаем каждую машину в виде данных запакованных в словарь
        for dictionary in dataArray {
            let entity = NSEntityDescription.entity(forEntityName: "Car", in: context)
            let car = NSManagedObject(entity: entity!, insertInto: context) as! Car
            //распаковываем словарь и заполняем свойства Car
    ...
    //вспомогательная функция получения ргб цвета
